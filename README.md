...
setup in minutes; automatically turning your logs into rich structured events. Why settle for
closed summaries and samples of your data when you can have open, complete access to all of them?
...
structured logging system. It works directly with the standard `Logger`, there are no agents or
special APIs. It turns this:
...
Allowing you to run queries like this:
