...
within that process. Custom contexts, specifically, allow you to extend beyond contexts already defined in the [`Timber.Contexts`](lib/timber/contexts) namespace.
