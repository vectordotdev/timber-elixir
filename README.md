...
[rich JSON events that contain critical event and context data](https://timber.io/docs/elixir/events-and-context).
...
Allowing you to run powerful queries in the [Timber console](https://app.timber.io) like:
