  ...
  describe "Mix.Tasks.Timber.Install.run/1" do
    ...
    test "end-to-end success" do
      ...
      FakeHTTPClient.stub(:request, fn
        :get, [{'Authorization', 'Basic YXBpX2tleQ=='}, {'X-Installer-Session-Id', _session_id}], "https://api.timber.io/installer/application", [] ->
